...
Open now navigates by encoded stable ID to the browser workbench shell. Picker, scanning, clone/import, running or failed workbench close, search, user sorting, tags, path mutation, and lifecycle controls remain later scope.
