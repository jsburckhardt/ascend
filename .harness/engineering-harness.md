...
- BL-013 project-isolation signal: just verify-project-runtime-isolation runs the 24-call fake matrix and no-retry three-Git-fixture Chromium A/B/C episode; just proof-project-runtime-isolation-residual-audit checks public/restricted evidence, per-project/global cleanup, runtime-data absence, fixture integrity, and unrelated-control cleanup. The signal is local, finite, offline, and makes no BL-014, BL-015, or lifecycle claim.
