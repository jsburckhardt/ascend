...
The retained comparison is b1000003-0000-4000-8000-000000000009 at ../../work-items/9-bl-003-select-a-viable-browser-workbench-presentation/implementation/evidence/comparison.json. Embedded eligibility was true and full-page eligibility was true. Embedded retained 5 blocking and 27 non-blocking occurrences with median 12121 ms. Full-page retained 3 blocking and 33 non-blocking occurrences with median 11179 ms.

## Decision

Use full-page code-server with a minimal Ascend header as the browser workbench presentation for authoritative desktop Chromium workflows. The ordered selector chose it at the first strict tie-breaker: fewer blocking browser protocol violations (3 versus 5). Reject embedded for this decision.
...
- The selected candidate retained 33 non-blocking warning occurrences that remain visible evidence.
