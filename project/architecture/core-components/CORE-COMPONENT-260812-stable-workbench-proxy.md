...
- A `WorkbenchProxyManager` accepts project-library and project-runtime boundaries plus injected HTTP, WebSocket, clock, timeout, event, and project-attributed audit adapters.
