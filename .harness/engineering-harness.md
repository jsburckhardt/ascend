...
- BL-010 project-runtime signal: just verify-project-runtime covers the deterministic contract and fake matrix; just proof-project-runtime runs the one real manager episode; just proof-project-runtime-residual-audit checks exact retained PID identity and listener inode. Harness boot remains non-persistent.
...
- BL-010 project-runtime evidence: test-results/bl-010/project-runtime/fake-matrix.json, episode.json, and residual-audit.json (generated and ignored); the retained AC mapping is the Issue #25 implementation record.
