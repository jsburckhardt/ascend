...
describe('runtime reconciliation contract', () => {
  it('keeps BL-019 vocabularies and bounds closed', () => {
    ...
    expect(RUNTIME_FAILURE_CATEGORIES.length).toBe(21)
    expect(RUNTIME_STOP_REJECTION_CATEGORIES.length).toBe(10)
    expect(RUNTIME_RESTART_REJECTION_CATEGORIES.length).toBe(10)
